            ...
            {isLoading ? <Spinner visible={isLoading} /> :
                <>
                    ...
                    <View style={styles.mid}>
                        <Text style={{ fontSize: 18, fontWeight: 'bold' }} >Recognize Dogs & Cats</Text>
                        <Text style={{ fontSize: 16, color: 'gray', marginTop: 20, lineHeight: 30, marginHorizontal: 18 }} >An application that allows identification and provides information about dogs and cats!</Text>
                    </View>
                    <View style={styles.bottom}>
                        <TouchableOpacity style={styles.button} onPress={pickImage}>
                            <Text style={{ color: 'white' }}>Select Image - Animal Species for Identification.</Text>
                        </TouchableOpacity>
                    </View>
                </>
            }
